# Generated by Django 3.2.4 on 2021-07-26 18:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book_detail', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.book')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('user_type', models.CharField(choices=[(1, 'H.O.D'), (2, 'Staff'), (3, 'Student')], max_length=10)),
