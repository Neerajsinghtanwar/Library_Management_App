...
urlpatterns = [
    ...
    # path('issuedbooks/', views.IssuedBookView.as_view({'get':'list', 'post':'create'}), name='issuedbooks'),
    # path('issuedbooks/<int:pk>', views.IssuedBookView.as_view({'get':'retrieve', 'put':'update', 'delete':'destroy'}), name='issuedbookspk'),
